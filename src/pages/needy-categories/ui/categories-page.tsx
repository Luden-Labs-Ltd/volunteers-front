...
import {CategoryDetailsView} from "@/pages/needy-categories/ui/category-details-view.tsx";
            ...
            <div className="fixed top-0 left-0 right-0 z-[50] w-[398px] mx-auto bg-gradient-to-b from-blue-50 to-white pt-16 pb-2 px-[20px]">
                ...
                {step === `details` &&
                    <p className="mt-2 text-gray-500 text-[18px] font-normal">
                        Details will help us match the right volunteers to you.
                    </p>
                }

            </div>
            {step === 'categories' && (
                <CategoriesView onNext={() => setStep('details')} />
            )}
