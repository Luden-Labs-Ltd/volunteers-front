    ...
    return (
        <div className="flex items-center justify-center gap-4 mb-6">
            <a
                ...
                className="w-[52px] h-[52px] flex items-center justify-center rounded-xl border border-[#004573] bg-white shadow-[1px_1px_0_0_#004573,2px_2px_0_0_#004573]"
            >
                {/* Иконку делаем меньше контейнера (30px), чтобы были отступы */}
                <Icon iconId="icon-whatsapp" size={30} className="shrink-0" />
            </a>
